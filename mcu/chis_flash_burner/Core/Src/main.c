...
static void MX_GPIO_Init(void)
{
    ...
    GPIO_InitStruct.Pin = a16_Pin | a17_Pin | a18_Pin | a19_Pin | a20_Pin | a21_Pin | a22_Pin |
                          a23_Pin;
    ...
    GPIO_InitStruct.Pin = ad0_Pin | ad1_Pin | ad2_Pin | ad10_Pin | ad11_Pin | ad12_Pin | ad13_Pin |
                          ad14_Pin | ad15_Pin | ad3_Pin | ad4_Pin | ad5_Pin | ad6_Pin | ad7_Pin |
                          ad8_Pin | ad9_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
